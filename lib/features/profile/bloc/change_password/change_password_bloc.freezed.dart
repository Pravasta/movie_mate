...
class _$ChangePasswordImpl implements _ChangePassword {
  const _$ChangePasswordImpl(this.newPassword);
  ...
  @override
  String toString() {
    return 'ChangePasswordEvent.changePassword(newPassword: $newPassword)';
  }
...
abstract class _ChangePassword implements ChangePasswordEvent {
  const factory _ChangePassword(final String newPassword) =
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'ChangePasswordState.success(success: $success)';
  }
